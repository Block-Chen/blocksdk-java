...
public class Dash : Base
    {
        ...
        public string getBlock(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/dash/block/"+request["block"],request);
        ...
        public string getMemPool(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/dash/mempool", request);
        ...
        public string getAddressInfo(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/dash/block/" + request["address"], request);
        ...
        {
            return this.request("GET", "/dash/address/" + request["address"]+"/balance", request);
        ...
        public string listWallet(Dictionary<string, string> request)
        {
            ...
            return this.request("GET", "/dash/wallet", request);
        ...
        public string createWallet(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/dash/wallet", request);
        }

        public string loadWallet(Dictionary<string, string> request)
        {
            return this.request("POST", "/dash/wallet" + request["wallet_id"]+"/load", request);
        }

        public string unLoadWallet(Dictionary<string, string> request)
        {
            return this.request("POST", "/dash/wallet" + request["wallet_id"] + "/unload", request);
        }
        ...
        public string createWalletAddress(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/dash/wallet/" + request["wallet_id"] + "/address", request);
        ...
        public string getWalletTransaction(Dictionary<string, string> request)
        {
            ...
            refineValues(request, false);
            return this.request("GET", "/dash/wallet/" + request["wallet_id"] + "/transaction", request);
        ...
        public string sendToAddress(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/dash/wallet/" + request["wallet_id"] + "/sendtoaddress", request);
        ...
        public string sendMany(Dictionary<string, string> request)
        {
            ...
            return this.request("POST", "/dash/wallet/" + request["wallet_id"] + "/sendmany", request);

        }

        public string sendTransaction(Dictionary<string, string> request)
        { 
             return this.request("POST", "/dash/transaction/", request);
        }
